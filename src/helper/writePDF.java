...
//    MauSacBUS mausacBus = new MauSacBUS();
    ...
    public void writePN(int maphieu) {
        ...
        try {
            ...
            String ncc = NhaCungCapDAO.getInstance().selectById(pn.getMaNCC()).getTenNCC();
            ...
            paragraph2.add(new Chunk(createWhiteSpace(5)));
            String diachincc = NhaCungCapDAO.getInstance().selectById(pn.getMaNCC()).getDiaChi();
            ...
            Paragraph paragraph4 = new Paragraph("Thời gian nhập: " + formatDate.format(pn.getNgayLap()), fontNormal10);
            ...
            Paragraph paraTongThanhToan = new Paragraph(new Phrase("Tổng thành tiền: " + formatter.format(pn.getThanhTienPN()) + "đ", fontBold15));
