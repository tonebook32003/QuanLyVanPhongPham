 ...
 * ItemTaskBar thiết lập hình dạng của mỗi item taskbar (phía bên trái)
 * Mỗi ItemTaskBar được thiết lập để khi clip vào mỗi item sẽ hiển thị giao diện Panel quản lý tương ứng
 */
